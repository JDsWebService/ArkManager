            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="custom-control custom-switch">
                        {{ Form::checkbox('use_true_values', true, true, ['class' => 'custom-control-input', 'id' => 'use_true_values']) }}
                    ...
                    <div class="custom-control custom-switch mt-3">
                        {{ Form::checkbox('use_stat_levels', true, false, ['class' => 'custom-control-input', 'id' => 'use_stat_levels']) }}
