    ...
    <div class="row justify-content-center">
        <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <label for="level">Previous Dino's Level</label>
                    {{ Form::number('level', null, ['class' => 'form-control', 'placeholder' => $newestDino->level]) }}
                </div>
            </div>
            <hr>
            <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                @if($baseDino->health != 0)
                    <div class="col-sm-3 mt-3">
                        ...
                        {{ Form::number('health', null, ['class' => 'form-control', 'placeholder' => $newestDino->health, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->stamina != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="stamina">Stamina</label>
                        {{ Form::number('stamina', null, ['class' => 'form-control', 'placeholder' => $newestDino->stamina, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->oxygen != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="oxygen">Oxygen</label>
                        {{ Form::number('oxygen', null, ['class' => 'form-control', 'placeholder' => $newestDino->oxygen, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->food != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="food">Food</label>
                        {{ Form::number('food', null, ['class' => 'form-control', 'placeholder' => $newestDino->food, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->weight != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="weight">Weight</label>
                        {{ Form::number('weight', null, ['class' => 'form-control', 'placeholder' => $newestDino->weight, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->damage != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="damage">Melee Damage</label>
                        {{ Form::number('damage', null, ['class' => 'form-control', 'placeholder' => $newestDino->damage, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->movement != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="movement">Movement Speed</label>
                        {{ Form::number('movement', null, ['class' => 'form-control', 'placeholder' => $newestDino->movement, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->crafting != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="crafting">Crafting Skill</label>
                        {{ Form::number('crafting', null, ['class' => 'form-control', 'placeholder' => $newestDino->crafting, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->torpidity != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="torpidity">Torpidity</label>
                        {{ Form::number('torpidity', null, ['class' => 'form-control', 'placeholder' => $newestDino->torpidity, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->water != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="water">Water</label>
                        {{ Form::number('water', null, ['class' => 'form-control', 'placeholder' => $newestDino->water, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->temperature != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="temperature">Temperature</label>
                        {{ Form::number('temperature', null, ['class' => 'form-control', 'placeholder' => $newestDino->temperature, 'step' => ".1"]) }}
                    </div>
                @endif
                @if($baseDino->fortitude != 0)
                    <div class="col-sm-3 mt-3">
                        <label for="fortitude">Fortitude</label>
                        {{ Form::number('fortitude', null, ['class' => 'form-control', 'placeholder' => $newestDino->fortitude, 'step' => ".1"]) }}
                    </div>
                @endif
            </div>
