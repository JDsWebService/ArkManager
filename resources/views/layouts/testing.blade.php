...
<head>
    ...
    <link rel="stylesheet" href="app/css/owl.transitions.css">
    ...
    <!-- Colors CSS -->
    <link rel="stylesheet" type="text/css" href="app/css/color/green.css">
    ...
    <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img class="img-responsive" src="app/images/header-bg-1.jpg" alt="slider">
                <div class="slider-content">
                    <div class="col-md-12 text-center">
                        <h1 class="animated3">
                            <span><strong>Fame</strong> for the highest</span>
                        </h1>
                        <p class="animated2">At vero eos et accusamus et iusto odio dignissimos<br> ducimus qui blanditiis
            ...
            <div class="item">
                <img class="img-responsive" src="app/images/header-back.png" alt="slider">
            ...
            <div class="item">
                <img class="img-responsive" src="app/images//galaxy.jpg" alt="slider">
                <div class="slider-content">
                    <div class="col-md-12 text-center">
                        <h1 class="animated2">
                            <span>The way of <strong>Success</strong></span>
                        </h1>
                        <p class="animated1">At vero eos et accusamus et iusto odio dignissimos<br> ducimus qui blanditiis
                            praesentium voluptatum</p>
                        <a class="animated3 slider btn btn-primary btn-min-block" href="#">Get Now</a><a
                            class="animated3 slider btn btn-default btn-min-block" href="#">Live Demo</a>
...
<section class="call-to-action">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Libero tempore soluta nobis est eligendi</br> optio cumque nihil impedit minus id quod maxime </br>placeat
                    facere possimus, omnis voluptas assumenda est</h1>
    ...
    <div class="modal-content">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="app/images/portfolio/img1.jpg" class="img-responsive" alt="..">
                </div>
                <div class="col-md-6">
                    <img src="app/images/portfolio/img1.jpg" class="img-responsive" alt="..">
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="welcome-section text-center">
                    <img src="app/images/about-01.jpg" class="img-responsive" alt="..">
                    <h4>Office Philosophy</h4>
                    <div class="border"></div>
                    <p>Duis aute irure dolor in reprehen derit in voluptate velit essecillum dolore eu fugiat nulla pariatur.
                        Lorem reprehenderit</p>
                </div>
            </div>

            <div class="col-md-4">
                <div class="welcome-section text-center">
                    <img src="app/images/about-02.jpg" class="img-responsive" alt="..">
            ...
            <div class="col-md-4">
                <div class="welcome-section text-center">
                    <img src="app/images/about-03.jpg" class="img-responsive" alt="..">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="carousel-example-generic" class="carousel slide about-slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="app/images/about-01.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="app/images/about-02.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="app/images/about-03.jpg" alt="">
                        </div>
                ...
                <div id="team-section">
                    ...
                    <div class="our-team">
                        ...
                        <div class="team-member">
                            <img src="app/images/team/manage-1.png" class="img-responsive" alt="">
                        ...
                        <div class="team-member">
                            <img src="app/images/team/manage-2.png" class="img-responsive" alt="">
                            <div class="team-details">
                                <h4>John Doe</h4>
                                <p>Founder & Director</p>
                                <ul>
                        ...
                        <div class="team-member">
                            <img src="app/images/team/manage-3.png" class="img-responsive" alt="">
                            <div class="team-details">
                                <h4>John Doe</h4>
                                <p>Founder & Director</p>
                                <ul>
                        ...
                        <div class="team-member">
                            <img src="app/images/team/manage-4.png" class="img-responsive" alt="">
                            <div class="team-details">
                                <h4>John Doe</h4>
                                <p>Founder & Director</p>
                                <ul>
        ...
        <div id="testimonial-carousel" class="testimonials-carousel">
            ...
            <div class="testimonials item">
                <div class="testimonial-content">
                    <img src="app/images/testimonial/face_1.png" alt="">
                    <div class="testimonial-author">
                        <div class="author">John Doe</div>
                        <div class="designation">Organization Founder</div>
                    </div>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque<br> laudantium,
            ...
            <div class="testimonials item">
                <div class="testimonial-content">
                    <img src="app/images/testimonial/face_2.png" alt="">
                    <div class="testimonial-author">
                        <div class="author">Jane Doe</div>
                        <div class="designation">Lead Developer</div>
                    </div>
                    <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia<br> consequuntur
            ...
            <div class="testimonials item">
                <div class="testimonial-content">
                    <img src="app/images/testimonial/face_3.png" alt="">
                    <div class="testimonial-author">
                        <div class="author">John Doe</div>
                        <div class="designation">Honorable Customer</div>
                    </div>
                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit<br> anim
                        laborum. Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="clients">
                ...
                <div class="col-md-12">
                    <img src="app/images/logos/themeforest.jpg" class="img-responsive" alt="...">
                </div>

                <div class="col-md-12">
                    <img src="app/images/logos/creative-market.jpg" class="img-responsive" alt="...">
                </div>

                <div class="col-md-12">
                    <img src="app/images/logos/designmodo.jpg" class="img-responsive" alt="...">
                </div>
                ...
                <div class="col-md-12">
                    <img src="app/images/logos/microlancer.jpg" class="img-responsive" alt="...">
                </div>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="pro-block text-center"
                    ...
                    <h1 style="font-size: 25px; line-height: 1; font-weight: 600;">You have downloaded free version of <a
                            href="https://themefisher.com/products/fame-free-html-website-template/">Fame</a>.</h1>
                    ...
                    <a href="https://themefisher.com/products/fame-free-html-website-template/#download-area"
                       target="_blank" class="btn btn-primary"
                       style="margin-bottom: 20px; letter-spacing: 2px; font-weight: 700; padding: 16px 45px;">Get Premium
                        Version</a>
                    <p><strong>By purchasing the pro version you are actually helping us to contribute the whole community by
                            providing free templates.</strong></p>
                </div>
            </div>
        </div>
    </div>
...
<script src="app/js/cbpAnimatedHeader.js"></script>
