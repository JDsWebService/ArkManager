    ...
    <div class="col-sm-8 trade-item-summary">
        <table class="table table-borderless table-sm bg-transparent">
            ...
            <tr>
                ...
                <td class="text-center">{{ $request->payment_quantity }}</td>
            </tr>
            <!-- End Item Quantity -->
            ...
            @if($soldItem->hasQuality)
                <tr>
                    ...
                    <td class="text-center">
                        @switch($request->payment_quality)
                            @case("primitive")
        ...
        <!-- Send Item Armor -->
            ...
            <!-- Item Hypothermic -->
                <tr>
                    ...
                    <td class="text-center">{{ $request->payment_hypothermic }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $request->payment_hyperthermic }}</td>
                </tr>
        ...
        <!-- Item Damage -->
            @if($item->hasDamage)
                <tr>
                    ...
                    <td class="text-center">{{ $request->payment_damage }}%</td>
                </tr>
            @endif
        <!-- End Item Damage -->
            ...
            @if($item->hasDurability)
                <tr>
                    ...
                    <td class="text-center">{{ $request->payment_durability }}</td>
                </tr>
            @endif
        <!-- End Item Durability -->
