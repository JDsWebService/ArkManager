        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 text-center">
                    ...
                    <img src="{{ asset('images/app/data-security.png') }}" class="w-25" alt="Secure Data Via SSL Encryption">
                    <a href="https://stripe.com/about"><img src="{{ asset('images/app/secure-payments.png') }}" class="w-50" alt="Secure Payments By Stripe"></a>
